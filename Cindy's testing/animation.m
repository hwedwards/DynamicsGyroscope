function animation()
    ...
    % Big disc
    [x1,y1,z1] = cylinder(r1,1000);
    z1 = z1*t1;

    % Gyro axle
    [x2,y2,z2] = cylinder(r3,10);
    z2 = z2*L;
    z2 = z2-L;

    % TODO: plot all the components of the gyro. can model them all as
    % cylinders
    % TODO: then translate them to their initial positions.
